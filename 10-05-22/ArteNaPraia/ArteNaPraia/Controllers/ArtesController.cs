...
namespace ArteNaPraia.Controllers
{
    public class ArtesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdArte,Nome,Descricao,IdArtista")] Arte arte)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdArte,Nome,Descricao,IdArtista")] Arte arte)
        {
            if (id != arte.IdArte)
            {
                return NotFound();
