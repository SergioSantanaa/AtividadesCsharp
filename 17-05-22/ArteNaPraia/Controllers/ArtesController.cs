...
namespace ArteNaPraia.Controllers
{
    public class ArtesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdArte,Nome,Preco,EmExposicao,Descricao,IdArtista")] Arte arte)
        {
            ...
            ViewData["IdArtista"] = new SelectList(_context.Artista, "IdArtista", "Nome", arte.IdArtista);
            arte.Preco=0;
            return View(arte);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["IdArtista"] = new SelectList(_context.Artista, "IdArtista", "IdArtista", arte.IdArtista);
            return View(arte);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdArte,Nome,Preco,EmExposicao,Descricao,IdArtista")] Arte arte)
        {
            if (id != arte.IdArte)
            {
                return NotFound();
